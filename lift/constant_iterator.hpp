...
namespace lift
{
  ...
  template<typename T> class constant_iterator<const T>
  {
  ...
  public:
    ...
    constant_iterator(const constant_iterator& x)
      : _(x._), _i(x._i)
    {
    }

    explicit constant_iterator(reference t)
      : _(t), _i()
    {
    }
    ...
    difference_type operator-(const constant_iterator& i)
    {
      return _i - i._i;
    }

    bool operator==(const constant_iterator& i)
    {
      return _i == i._i;
    }
  ...
  template<typename T> constant_iterator<const T> make_constant_iterator(const T& t)
  {
