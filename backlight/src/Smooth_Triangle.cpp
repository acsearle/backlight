...
bool coTriangle_Smooth::Bound_Intersection(cRay& RInitial, double t_min,
                                           double t_max, poObject poParent) {
  cRay nRay = RInitial;
  ciObject ICurrent;
...
ciObject coTriangle_Smooth::Intersection(cRay& RInitial, double t_min,
                                         double t_max, poObject poParent) {
  ciObject IBest;
  lift::vector<double, 3> o, d;
...
lift::vector<double, 3> coTriangle_Smooth::Normal(lift::vector<double, 3> o) {
  ...
  n = (m_normal_1 * m_u) + (m_normal_2 * m_v) +
      (m_normal_3 * (1.0 - m_u - m_v));
