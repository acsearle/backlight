...
class cMatrix : public RefCount
{
  ...
  public:
    ...
    //---- CTORS ------------------------------------------
      ...
      cMatrix(long type) { Initialize(); m_type = type; };

  
      cMatrix(  double a11, double a21, double a31,
    ...
    //---- INITIALIZATION ------------------------------------------
      ...
      {
        m_type = TT_NONE;
        m_ary[0][0] = 1; m_ary[0][1] = 0; m_ary[0][2] = 0;
        m_ary[1][0] = 0; m_ary[1][1] = 1; m_ary[1][2] = 0;
        m_ary[2][0] = 0; m_ary[2][1] = 0; m_ary[2][2] = 1;
        m_ary[3][0] = 0; m_ary[3][1] = 0; m_ary[3][2] = 0;
      };
      ...
      _inline void Initialize(
        double _a11, double _a21, double _a31,
      ...
      _inline void Initialize( lift::vector<double, 3> v1, lift::vector<double, 3> v2, lift::vector<double, 3> v3, lift::vector<double, 3> v4 )
      {
    ...
    //---- ACCESSORS ------------------------------------------
      ...
      _inline lift::vector<double, 3> & Vector(unsigned long n)
      {
        return m_ary[n];
      };
    ...
    //---- OPERATORS ------------------------------------------
      ...
      _inline lift::vector<double, 3> operator & (lift::vector<double, 3> & v) { return TransformDirection(v); };
      _inline lift::vector<double, 3> operator * (lift::vector<double, 3> & v) { return TransformLocation(v);  };
      _inline lift::vector<double, 3> operator / (lift::vector<double, 3> & v) { return TransformNormal(v);    };
...
_inline cMatrix cMatrix::operator * (cMatrix &m) 
{
    ...
    t.m_ary[0][0] = m_ary[0][0]*m.m_ary[0][0] + m_ary[0][1]*m.m_ary[1][0] + m_ary[0][2]*m.m_ary[2][0];
    t.m_ary[0][1] = m_ary[0][0]*m.m_ary[0][1] + m_ary[0][1]*m.m_ary[1][1] + m_ary[0][2]*m.m_ary[2][1];
    t.m_ary[0][2] = m_ary[0][0]*m.m_ary[0][2] + m_ary[0][1]*m.m_ary[1][2] + m_ary[0][2]*m.m_ary[2][2];

    t.m_ary[1][0] = m_ary[1][0]*m.m_ary[0][0] + m_ary[1][1]*m.m_ary[1][0] + m_ary[1][2]*m.m_ary[2][0];
    t.m_ary[1][1] = m_ary[1][0]*m.m_ary[0][1] + m_ary[1][1]*m.m_ary[1][1] + m_ary[1][2]*m.m_ary[2][1];
    t.m_ary[1][2] = m_ary[1][0]*m.m_ary[0][2] + m_ary[1][1]*m.m_ary[1][2] + m_ary[1][2]*m.m_ary[2][2];

    t.m_ary[2][0] = m_ary[2][0]*m.m_ary[0][0] + m_ary[2][1]*m.m_ary[1][0] + m_ary[2][2]*m.m_ary[2][0];
    t.m_ary[2][1] = m_ary[2][0]*m.m_ary[0][1] + m_ary[2][1]*m.m_ary[1][1] + m_ary[2][2]*m.m_ary[2][1];
    t.m_ary[2][2] = m_ary[2][0]*m.m_ary[0][2] + m_ary[2][1]*m.m_ary[1][2] + m_ary[2][2]*m.m_ary[2][2];
