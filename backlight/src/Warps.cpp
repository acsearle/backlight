...
_inline double acosh_p(double x) { return x + sqrt(x * x - 1.0); };

_inline double acosh_n(double x) { return x - sqrt(x * x - 1.0); };
...
cEvent cwWarp::UnWarp(const cEvent & o)
{
    ...
    switch(m_warp_type)
    {
        ...
        case WT_TOROIDAL_1:   // Not much point without a torus!
            ...
            //if( xtorad(o[0])<0.0 || xtorad(o[1])<0.0 ) { u = -u; v = -v; w =
-w; };
...
* PI), cos(u * 2 * PI) *cos(v * PI) );
        ...
        case WT_TOROIDAL_1:   // Not much point without a torus!
            ...
            du = lift::make_vector<double>(   1/sqr(cos(v *2 *PI)),      -tan(u
*2 *PI), -tan(u *2 *PI) *tan(v *2 *PI) );
            dv = lift::make_vector<double>( -tan(u *2 *PI) *tan(v *2 *PI),
-tan(u *2 *PI), 1/sqr(cos(v *2 *PI))  );
            dw = o1[0] / w;
        ...
        case WT_TOROIDAL_2:   // Not much point without a torus!
            ...
            du = lift::make_vector<double>( -cos( 2 *PI *(u-0.5) ), sin( 2 *PI
*(u-0.5) ), 0.0 );
            dw = o1[0] / w;
        ...
        case WT_TOROIDAL_3:   // Not much point without a torus!
            ...
            dv = lift::make_vector<double>( cos(2 *PI *u) * sin(2 *PI *v) *
sinh(w), cos(2 *PI *v) *cosh(w) - 1, -sin(2 *PI *u) *sin(2 *PI *v) *sinh(w) );
            dw = lift::make_vector<double>( cos(2 *PI *u) * (1-cos(2 *PI *v)
*cosh(w)), sin(2 *PI *v) * sinh(w), (1 - cos(2 *PI *v) *cosh(w)) * sin(2 *PI *u)
);
        break;
...
cEvent cwPlanar::Warp(const cEvent& o) { return o; };
...
cEvent cwPlanar::UnWarp(const cEvent& o) { return o; };
...
void cwSpherical::Warp_Frame(cEvent& e, cCoordinate_Frame& f) {
  ...
  f.dv() =
      lift::make_vector<double>(sin(u * 2 * PI) * cos(v * PI), -sin(v * PI),
                                cos(u * 2 * PI) * cos(v * PI));
  f.dw() = e.p() / w;
};
...
void cwToroidal_1::Warp_Frame(cEvent& e, cCoordinate_Frame& f) {
  ...
  f.du() = lift::make_vector<double>(1 / sqr(cos(v * 2 * PI)), -tan(u * 2 * PI),
                                     -tan(u * 2 * PI) * tan(v * 2 * PI));
  f.dv() =
      lift::make_vector<double>(-tan(u * 2 * PI) * tan(v * 2 * PI),
                                -tan(u * 2 * PI), 1 / sqr(cos(v * 2 * PI)));
  f.dw() = e.p() / w;
...
void cwToroidal_2::Warp_Frame(cEvent& e, cCoordinate_Frame& f) {
  ...
  f.du() = lift::make_vector<double>(-cos(2 * PI * (u - 0.5)),
                                     sin(2 * PI * (u - 0.5)), 0.0);
  f.dw() = e.p() / w;
...
void cwToroidal_3::Warp_Frame(cEvent& e, cCoordinate_Frame& f) {
  ...
  f.dv() =
      lift::make_vector<double>(cos(2 * PI * u) * sin(2 * PI * v) * sinh(w),
                                cos(2 * PI * v) * cosh(w) - 1,
                                -sin(2 * PI * u) * sin(2 * PI * v) * sinh(w));
  f.dw() = lift::make_vector<double>(
      cos(2 * PI * u) * (1 - cos(2 * PI * v) * cosh(w)),
      sin(2 * PI * v) * sinh(w),
      (1 - cos(2 * PI * v) * cosh(w)) * sin(2 * PI * u));
};
...
void cwSpherical::UnWarp_Frame(cEvent& e, cCoordinate_Frame& f){
    ...
    f.du() = lift::make_vector<double>( cos(u * 2 * PI), 0, -sin(u * 2 * PI) );
    f.dv() = lift::make_vector<double>( sin(u * 2 * PI) *cos(v * PI),-sin(v *
    PI), cos(u * 2 * PI) *cos(v * PI) );
    f.dw() = e[0] / w;
    */
...
void cwToroidal_1::UnWarp_Frame(cEvent& e, cCoordinate_Frame& f){
    ...
    f.du() = lift::make_vector<double>(   1/sqr(cos(v *2 *PI)),      -tan(u *2
    *PI), -tan(u *2 *PI) *tan(v *2 *PI) );
    f.dv() = lift::make_vector<double>( -tan(u *2 *PI) *tan(v *2 *PI),  -tan(u
    *2 *PI), 1/sqr(cos(v *2 *PI))  );
    f.dw() = e[0] / w;
...
void cwToroidal_2::UnWarp_Frame(cEvent& e, cCoordinate_Frame& f){
    ...
    f.du() = lift::make_vector<double>( -cos( 2 *PI *(u-0.5) ), sin( 2 *PI
    *(u-0.5) ), 0.0 );
    f.dw() = e[0] / w;
...
void cwToroidal_3::UnWarp_Frame(cEvent& e, cCoordinate_Frame& f){
    ...
    temp = cos(2 *PI *u)-cosh(w);
    f.du() = lift::make_vector<double>( sin(2 *PI *u),0,-cos(2 *PI *u) );
    f.dv() = lift::make_vector<double>( cos(2 *PI *u) * sin(2 *PI *v) * sinh(w),
    cos(2 *PI *v) *cosh(w) - 1, -sin(2 *PI *u) *sin(2 *PI *v) *sinh(w) );
    f.dw() = lift::make_vector<double>( cos(2 *PI *u) * (1-cos(2 *PI *v)
    *cosh(w)), sin(2 *PI *v) * sinh(w), (1 - cos(2 *PI *v) *cosh(w)) * sin(2 *PI
    *u) );
    */
};
