...
//    long //i, 
    ...
    m_normal = (m_matGeometry.invert()).TransformNormal( lift::make_vector<double>( 1, 0, 0 ) );
...
ciObject coPlane::Intersection(cRay &RInitial, double t_min, double t_max, poObject poParent)
{
