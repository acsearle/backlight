...
pToken  ctTransform::Load(pToken T)
{
  ...
  switch(type)
  {
    ...
    case TRANSFORM_ROTATE:
      ...
      Rx.Initialize( TRANSFORM_MATRIX,  1,0,0,0,  0,cos(v[0]),-sin(v[0]),0,  0,sin(v[0]),cos(v[0]),0 );
      Ry.Initialize( TRANSFORM_MATRIX,  cos(v[1]),0,sin(v[1]),0,  0,1,0,0,  -sin(v[1]),0,cos(v[0]),0 );
      Rz.Initialize( TRANSFORM_MATRIX,  cos(v[2]),-sin(v[2]),0,0,  sin(v[2]),cos(v[2]),0,0,  0,0,1,0 );
