...
class lift::vector<double, 3> : public RefCount
{
  ...
  public:
    ...
    lift::make_vector<double>(double _x, double _y, double _z) { m_ary[0] = _x; m_ary[1] = _y; m_ary[2] = _z;};
    ...
    _inline double      operator *  (lift::vector<double, 3> & v); // Dot product
    ...
    _inline lift::vector<double, 3>  operator -  (lift::vector<double, 3> & v);
    _inline lift::vector<double, 3>  operator /  (lift::vector<double, 3> & v); // Cross product
  ...
  */
   /*  _inline lift::vector<double, 3> & operator = (const lift::vector<double, 3> & v)
    {
...
/*
    ...
    _inline double maxcomp() { return MAX( fabs(m_ary[0]), MAX( fabs(m_ary[1]), fabs(m_ary[2]) ) ); };
...
lift::vector<double, 3> LorentzTransform(const lift::vector<double, 3>&, const lift::vector<double, 3> & v, const lift::vector<double, 3> & u);
...
class cCoordinate_Frame : public RefCount
{
  ...
  public:
    ...
    cCoordinate_Frame(lift::vector<double, 3> & du, lift::vector<double, 3> & dv, lift::vector<double, 3> & dw)
    {
      m_data[0] = du;
      m_data[1] = dv;
      m_data[2] = dw;
    ...
    cCoordinate_Frame LorentzTransform(lift::vector<double, 3> & v, lift::vector<double, 3> & u);
};
/*
//
// Global functions
...
_inline double gamma(const lift::vector<double, 3> & v) 
{
  ...
  {
    printf("gamma(lift::vector<double, 3>) : Attepted to calculate Lorentz factor for illegal velocity\n");
    assert(false);
  }
...
_inline lift::vector<double, 3> lift::vector<double, 3>::operator + (lift::vector<double, 3> & v) 
{
...
_inline lift::vector<double, 3> lift::vector<double, 3>::operator / (double f) 
{
  ...
  if(f == 0) {
    printf("lift::vector<double, 3>::operator / (double) : Attepted divide by zero\n");
    assert(false);
  }
...
_inline void lift::vector<double, 3>::Normalise(double f) 
{
  ...
  {
    printf("lift::vector<double, 3>::Normalise(double) : Attempted to normalise zero vector\n");
    assert(false);
  }
...
_inline lift::vector<double, 3>  lift::vector<double, 3>::operator & (lift::vector<double, 3> & v)
{
  return lift::make_vector<double>(m_ary[0] *v.m_ary[0],m_ary[1] *v.m_ary[1],m_ary[2] *v.m_ary[2]);
};
...
inline void Normalise(lift::vector<double, 3>& v, const double& n) { v *= n / abs(v); }
#endif
