...
class cScene : public RefCount {
 ...
 public:
  ...
  ciFrame CastRay(cRay &RInitial, lift::vector<double, 3> &v,
                  poObject poParent);
  cFColour Antialias(cFColour c00, cFColour c02, cFColour c20, cFColour c22,
                     double u_0, double v0_, double u_2, double v2_, pCamera C);
